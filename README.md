...
2. Copy the extension folder to `~/.local/share/gnome-shell/extensions/quicklaunch@td/`
3. Compile the settings schema:
   ```bash
   cd ~/.local/share/gnome-shell/extensions/quicklaunch@td
...
1. Open the extension preferences: `gnome-extensions prefs quicklaunch@td`
